              ...
              <form onSubmit={handleSubmit} className="space-y-7">
                ...
                >
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button variant="outline" type="button" className="w-full bg-transparent border border-black/10 dark:border-white/10" onClick={async () => {
                      setLoginError('');
                      setIsLoading(true);
                      try {
                  ...
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button variant="outline" type="button" className="w-full bg-transparent border border-black/10 dark:border-white/10">
